...
#ifndef TCV_API_V1_AUTH_OWNER_LOGIN
#define TCV_API_V1_AUTH_OWNER_LOGIN
...
namespace tcv::inside::api::v1::auth::owner::login {
    inline void handle(
        ...
        const auto r = tcv::service::AuthService::loginOwner(
            username,
            password,
...
#endif // TCV_API_V1_AUTH_OWNER_LOGIN
