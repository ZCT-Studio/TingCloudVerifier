...
#ifndef TCV_API_V1_AUTH_SUBUSER_LOGIN
#define TCV_API_V1_AUTH_SUBUSER_LOGIN
...
namespace tcv::inside::api::v1::auth::subuser::login {
    inline void handle(
        ...
        const auto r = tcv::service::AuthService::loginSubUser(
            username,
            password,
...
#endif // TCV_API_V1_AUTH_SUBUSER_LOGIN
